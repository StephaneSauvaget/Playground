export const en = {
  ...
  "memory.difficulty.easy.help": "Just a few pictures",
  "memory.difficulty.normal.help": "More pictures to remember",
  "memory.difficulty.hard.help": "Lots of pictures, and a big board",
  "memory.pattern.renard.alt": "A fox",
  "memory.pattern.fleur.alt": "A flower",
  "memory.pattern.etoile.alt": "A star",
  "memory.pattern.lune.alt": "A moon",
  "memory.pattern.pomme.alt": "An apple",
  "memory.pattern.poisson.alt": "A fish",
  "memory.pattern.ballon.alt": "A ball",
  "memory.pattern.gateau.alt": "A cake",
...
export const fr: Record<TranslationKey, string> = {
  ...
  "memory.difficulty.easy.help": "Juste quelques images",
  "memory.difficulty.normal.help": "Plus d'images à retenir",
  "memory.difficulty.hard.help": "Beaucoup d'images, et un grand plateau",
  "memory.pattern.renard.alt": "Un renard",
  "memory.pattern.fleur.alt": "Une fleur",
  "memory.pattern.etoile.alt": "Une étoile",
  "memory.pattern.lune.alt": "Une lune",
  "memory.pattern.pomme.alt": "Une pomme",
  "memory.pattern.poisson.alt": "Un poisson",
  "memory.pattern.ballon.alt": "Un ballon",
  "memory.pattern.gateau.alt": "Un gâteau",
